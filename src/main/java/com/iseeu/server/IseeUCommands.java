    ...
    public static void onRegisterCommands(final RegisterCommandsEvent event) {
        ...
        d.register(Commands.literal("iseeu")
                ...
                .then(Commands.literal("list")
                        ...
                        .then(Commands.argument("page", net.minecraft.commands.arguments.IntegerArgumentType.integer(1))
                                .executes(ctx -> cmdList(ctx, net.minecraft.commands.arguments.IntegerArgumentType.getInteger(ctx, "page")))))
